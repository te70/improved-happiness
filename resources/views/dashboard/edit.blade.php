...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">KeyOne Realty Group</a>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="container">
        <div class="row">
          <div class="card w-50">
          <div class="card-body">
    <form class="row g-3" method="POST" action="{{ route('home.update', $employee->id) }}">
      @csrf
        <div class="col-md-6">
          <label for="inputEmail4" class="form-label">First name</label>
          <input type="text" class="form-control" id="inputEmail4" name="firstName" value={{$employee->firstName}}>
        </div>
        <div class="col-md-6">
          <label for="inputPassword4" class="form-label">Last name</label>
          <input type="text" class="form-control" id="inputPassword4" name="lastName" value={{$employee->lastName}}>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <input type="password" class="form-control" id="inputPassword4" name="password" value={{$employee->password}}>
        </div>
        <div class="col-md-6">
          <label for="inputPassword4" class="form-label">Number</label>
          <input type="telephone" class="form-control" id="inputPassword4" name="number" value={{$employee->number}}>
        </div>
        <div class="col-md-6">
          <label for="inputEmail4" class="form-label">Department</label>
          <select id="inputState" class="form-select" name="department" value={{$employee->department}}>
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="inputPassword4"name="role" value={{$employee->role}}>
        </div>
        <div class="col-md-12">
          <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupFile01">Upload profile image</label>
            <input type="file" class="form-control" id="inputGroupFile01" name="profile_image">
          </div>
        </div>
        <div class="col-12">
